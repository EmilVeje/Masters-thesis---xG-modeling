...
Choosing GBM-model:
```{r}
modelname <- "GBM_2_AutoML_1_20251215_160153" # write the chosen model name from the "lbdf" dataframe
...
Choosing GBM:
```{r}
modelname <- "GBM_2_AutoML_1_20251215_160756" # write the chosen model name from the "lbdf" dataframe
cmod <- grep(modelname, lbdf$model_id, value=T)
cmod <- h2o.getModel(cmod)
summary(cmod)
```
